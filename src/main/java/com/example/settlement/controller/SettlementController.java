...
import com.example.settlement.dto.ArtistAccountResponse;
...
public class SettlementController {
    ...
    public ResponseEntity<ArtistPayoutResponseDTO> getSettlement(
            @RequestHeader("x-user-id") Long artistId) {

        log.info(">>> [ARTIST_SETTLEMENT] 정산 대시보드 요청 수신 - ArtistId: {}", artistId);
        ArtistPayoutResponseDTO response = artistSettlementService.getSettlementDashboard(artistId);
